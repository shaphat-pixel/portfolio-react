           ...
           <Container  fluid className="margin">
            ...
            <Row className="margin" >   
                <Col xs={2}>
                    ...
                    <div onClick={activeHash} className="ripple nav-button"><a href="#"> { hashClick ==true? <img width ="30px" height="30px" src="https://cdn-icons-png.flaticon.com/512/1946/1946421.png"/>: <img width="30px" height="30px" src="https://cdn-icons-png.flaticon.com/512/1946/1946421.png"/>}</a> Twitter builds</div><br/><br/>
...
export default TwitterBuildsPage;
