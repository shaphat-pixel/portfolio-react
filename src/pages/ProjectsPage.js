           ...
           <Container  fluid className="margin">
            ...
            <Row className="margin" >   
                <Col xs={2}>
                    ...
                    <div onClick={activeCommunities} className="ripple nav-button"><a href="#"> { communitiesClick ==true? <img width ="30px" height="30px" src="https://cdn-icons-png.flaticon.com/512/4121/4121044.png"/>: <img width="30px" height="30px" src="https://cdn-icons-png.flaticon.com/512/4121/4121044.png"/>}</a> Projects</div><br/><br/>
