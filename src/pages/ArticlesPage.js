           ...
           <Container  fluid className="margin">
            ...
            <Row className="margin" >   
                <Col xs={2}>
                    ...
                    <div onClick={activeNotifications} className="ripple nav-button"><a href="#">{notificationsClick==true? <img width="30px" height="30px" src="https://cdn-icons-png.flaticon.com/512/3602/3602123.png"/>: <img width="30px" height="30px" src="https://cdn-icons-png.flaticon.com/512/3602/3602123.png"/>}</a> Articles </div><br/><br/>
